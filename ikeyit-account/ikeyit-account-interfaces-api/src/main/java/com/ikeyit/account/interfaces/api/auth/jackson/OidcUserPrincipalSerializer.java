...
public class OidcUserPrincipalSerializer extends JsonSerializer<OidcUserPrincipal> {

    @Override
    public void serializeWithType(OidcUserPrincipal value, JsonGenerator jsonGenerator, SerializerProvider serializers, TypeSerializer typeSer) throws IOException {
    ...
    @Override
    public void serialize(OidcUserPrincipal value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        jsonGenerator.writeStartObject();
        serialize(value, jsonGenerator);
        jsonGenerator.writeEndObject();
    }

    private void serialize(OidcUserPrincipal value, JsonGenerator jsonGenerator) throws IOException {
